...
los nombres reales de "buyer"/"supplier" que va encontrando (ver
sercop_lib/entity_index.py), que es la fuente de verdad más confiable
porque son los nombres tal como aparecen en los datos de SERCOP.
"""
